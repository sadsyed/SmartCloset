 ...
 * {@link ssar.smartcloset.ClosetFragment.OnClosetFragmentListener} interface
...
public class ClosetFragment extends Fragment {
    ...
    private OnClosetFragmentListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.OnClosetFragmentListener(uri);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnClosetFragmentListener) activity;
     ...
     */
    public interface OnClosetFragmentListener {
