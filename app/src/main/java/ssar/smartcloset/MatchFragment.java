...
public class MatchFragment extends Fragment {
    ...
    public static MatchFragment newInstance(String articleId, Boolean matchFilter) {
        ...
        if(!matchFilter) {
            ...
            findMatchButton.setOnClickListener(new Spinner.OnClickListener() {
               ...
               public void onClick(View view) {
                   ...
                   onMatchFragmentInteractionListener.onMatchFragmentInteraction(articleId, category);
               }
            });
